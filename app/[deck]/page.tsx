...
const DECK_DATA: Record<string, any> = {
  ...
  "corporate": {
    ...
    accent: "#4DFFFF",
    description: "Ditch the boring boardrooms. Foster team spirit with FPV RACING competitions and VR escape rooms that challenge communication and strategy. Designed for high-performing teams, our corporate experiences push the boundaries of collaboration."
  },
  "walkthrough": {
