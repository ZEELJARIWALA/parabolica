    ...
    if (isActive && videoRef.current) {
      ...
      if (playPromise !== undefined) {
        playPromise
          ...
          .catch((err) => {
            // Autoplay was prevented, try on muted
            if (videoRef.current) {
...
export function IntroSequence() {
  ...
  // Show intro every time (no sessionStorage)
  useEffect(() => {
  ...
  // Zone timer — advance through zones
  useEffect(() => {
  ...
  }, [zoneIndex, isExiting, shouldRender]);
