...
const photos = [
  ...
  { id: 3, src: "https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?q=80&w=2070&auto=format&fit=crop", title: "FPV RACING", category: "Drone Tech", year: "2026", description: "Train with professional-grade FPV RACINGs in our custom-built flight zone, designed for both beginners and elite pilots." },
...
export default function PhotoScroll() {
  ...
  const handleCardClick = (photo: any) => {
    setSelectedPhoto({
      ...
      image: photo.src,
      stack: ["F1 Simulator", "VR Arena", "FPV RACING"]
    });
    setIsModalOpen(true);
  };
